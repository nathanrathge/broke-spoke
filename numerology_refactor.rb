...
def display_numerology(birth_path_number)
   puts "\nYour BP Number is #{birth_path_number}.\n\n"
...
birthvar = birth_date
display_numerology(birth_path_number(birthvar))
display_numerology(birth_path_number($newbirthvar))